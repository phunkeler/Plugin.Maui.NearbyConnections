...
public partial class NearbyConnectionsService : INearbyConnectionsService
{
        ...
        IThumbnailService thumbnailService)
    {
        ...
        _nearbyConnections.AdvertisingStateChanged += OnAdvertisingStateChanged;
        _nearbyConnections.DiscoveringStateChanged += OnDiscoveringStateChanged;
    ...
    void OnDeviceFound(object? sender, DeviceFoundEventArgs e)
        => _messenger.Send(new DeviceFoundMessage(e.NearbyDevice, e.Timestamp));

    void OnDeviceLost(object? sender, DeviceLostEventArgs e)
    ...
    void OnDeviceDisconnected(object? sender, DeviceDisconnectedEventArgs e)
    {
