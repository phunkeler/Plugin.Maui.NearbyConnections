...
/// current observer — the background discovery loop and the underlying platform operation
...
public interface INearbyDiscoverer : IDisposable, IAsyncDisposable
{
    ...
    /// <summary>
    /// Delegates to <see cref="INearbyDevices.ConnectAsync"/>, adds the returned connection to
    /// active connections, and starts monitoring and payload forwarding.
    /// </summary>
    /// <remarks>
    /// If the underlying <see cref="INearbyDevices.ConnectAsync"/> call throws, the device
