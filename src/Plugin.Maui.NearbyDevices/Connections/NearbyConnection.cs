...
/// or the connect method on <see cref="INearbyDevices"/> (discoverer side).
...
public sealed class NearbyConnection : IAsyncDisposable
{
    ...
    /// <summary>
    /// Initializes a new <see cref="NearbyConnection"/> for use in test doubles of <see cref="INearbyDevices"/>.
    /// </summary>
