...
sealed class NearbyDeviceManager : INearbyDeviceManager
{
    ...
    readonly Action<NearbyDevice, NearbyDeviceState, DateTimeOffset> _onDeviceStateChanged;
    ...
    public NearbyDeviceManager(TimeProvider timeProvider, Action<NearbyDevice, NearbyDeviceState, DateTimeOffset> onDeviceStateChanged)
    {
        ArgumentNullException.ThrowIfNull(timeProvider);
        ArgumentNullException.ThrowIfNull(onDeviceStateChanged);
    ...
    public NearbyDevice? SetState(string id, NearbyDeviceState state)
    {
        ...
        {
            _onDeviceStateChanged(device, previousState, _timeProvider.GetUtcNow());
        }
