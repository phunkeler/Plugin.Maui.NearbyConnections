...
{
    /// <summary>
    /// The iOS adapter, typed — for the device tests, which drive its delegate-facing callback
    /// entry points directly.
    /// </summary>
    internal IosAdapter IosAdapter => (IosAdapter)_adapter!;

    partial void PlatformCreateAdapter() => _adapter = new IosAdapter(this);
