...
public class NearbyDevicesTests
{
    ...
    [TestClass]
    public sealed class WriteConnectionRequest : NearbyDevicesTests
    {
        [TestMethod]
    ...
    [TestClass]
    public sealed class ResolveConnectionTcs : NearbyDevicesTests
    {
        [TestMethod]
    ...
    [TestClass]
    public sealed class WriteDeviceFound : NearbyDevicesTests
    {
        [TestMethod]
    ...
    [TestClass]
    public sealed class WritePayload : NearbyDevicesTests
    {
        [TestMethod]
    ...
    [TestClass]
    public sealed class DisposeAsync : NearbyDevicesTests
    {
        [TestMethod]
